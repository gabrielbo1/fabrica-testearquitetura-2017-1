...
public class ServicoTarefa {
	...
	private final TarefaDAO tarefaDAO = new TarefaDAO(new TransacaoHibernate(), Tarefa.class);
	
	public TarefaDTO criarTarefa(final TarefaDTO tarefaDTO) {
		Tarefa tarefa = new Tarefa().NovaTarefa(tarefaDTO.getTitulo(), tarefaDTO.getDescricao());
	...
	public TarefaDTO atualizarTarefa(final TarefaDTO tarefaDTO)  {
		BlocoAtualizar<Tarefa> atualizacao = (registro) -> {
			return registro.NovaTarefa(tarefaDTO.getTitulo(), tarefaDTO.getDescricao());
		};
